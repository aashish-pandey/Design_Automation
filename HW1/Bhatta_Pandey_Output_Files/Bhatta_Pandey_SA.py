...
2. change the instance on the main file for the netlist you want to run. 
    For proper output of log file follow the following steps:
        i. ctrl + f to find occurences of Ptest_500 [or other netlist. there are three places we use this]
        ii. replace the instances with some other netlist you want to test for
