...
import Ptest_25000 as placement_data


def save_python_netlist(output_dir, data, filename="optimized_data.py"):
    """
...
# SIMULATED ANNEALING
# -------------------------------------------------
def solve_sa(data, seed=68, output_tag="ptest25000_full_run"):
    ...
    T = 10 if data_len < 1000 else 100
    alpha = 0.999 if data_len < 1000 else 0.99

    frozen_temp = 1e-109

    max_stagnant_steps = 1500 if data_len < 1000 else data_len
    stagnant_counter = 0
    prev_best = best_hpwl
    ...
    while T > frozen_temp:
        ...
        moves_per_temp = int(max(data_len, T * data_len//10))
        accepted_moves = 0
...
if __name__ == "__main__":
    ...
    result = solve_sa(data, output_tag="ptest25000_full_run")
